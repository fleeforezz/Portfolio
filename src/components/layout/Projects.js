...
export default function Projects() {
    return (
        <section id="projects" className="flex flex-col items-center px-14 py-24 transition-all mx-auto border">
            ...
            <div className="projects border grid grid-cols-3 max-sm:grid-cols-1 max-md:grid-cols-2 gap-10 py-20">
