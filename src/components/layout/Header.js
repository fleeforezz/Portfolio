...
export default function Header() {
    ...
    return (
        <header id="/">
            <div>
                <nav className="flex fixed nav-noise flex-row w-full items-center justify-around max-md:justify-between mx-auto p-4 backdrop-blur shadow-sm shadow-navigation_box_shadow z-50">
                    ...
                    <button onClick={handleClick} className="hidden max-md:flex">
